...
const RoadMarkings = props => (
  <div className="modal-container">
    ...
    <h2>Car Parks</h2>
    <p>Premier RoadMarkings Ltd have completed many car park markings to an excellent standard.</p>
    <Carousel className="modal__carousel">
      <img src="/assets/imgs/car_parks_1-min.png" />
      <img src="/assets/imgs/car_parks_2-min.png" />
