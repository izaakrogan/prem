...
export default class Footer extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      email: undefined,
      message: undefined,
      url: 'https://script.google.com/macros/s/AKfycbzg0hEAI_we45BxMXQyirRcTPGNbtjlIoiJY-eLGl2Wg_o3p_Y/exec',
    };
  ...
  handleSubmit(event) {
    ...
    if (!re.test(this.state.email)) {
      ...
      document.getElementById('form_message').innerHTML = 'Please check your email address.';
      return false;
    }
    ...
    xhr.onreadystatechange = () => {
      document.getElementById('form_message').style.display = 'block';
      document.getElementById('form_message').innerHTML = 'Thank you. We will respond as soon as possible.';
      ...
      <div className="footer-container">
        <div className="footer-container-content">
          <div className="contact-info">
            <h3>+01740 622518</h3>
            <h3>kelly@premier-roadmarkings.co.uk</h3>
            <div>
              <h3>Head Office:</h3>
